...
- [GLOBAL SETTINGS](./02a_GlobalSettings.md)
  - [GENERAL](./02a_GlobalSettings.md#general)
    ...
    - [USt-ID](./02a_GlobalSettings.md#ust-id)
  ...
  - [BELEGDRUCK](./02a_GlobalSettings.md#belegdruck)
    ...
    - [Logo-Druck Kompatibilitätsmodus](./02a_GlobalSettings.md#logo-druck-kompatibilitätsmodus)
  ...
  - [DATENÜBERTRAGUNG RETAILSUITE FAKTURA](./02a_GlobalSettings.md#datenübertragung-retailsuite-faktura)
    ...
    - [Standard-Kunde](./02a_GlobalSettings.md#standard-kunde)
    - [Shop-Lieferungen aktiv](./02a_GlobalSettings.md#shop-lieferungen-aktiv)
