...
- Follow stocks centrally and in real time   
    By connecting the *POS* system to the *Actindo Core1 Platform*, stock changes are always displayed in real-time and you have an overview of all stocks in one central location.
...
[comment]: <> (Können Payment terminals mittlerweile angeschlossen werden?)

- TSS provider connection   
    The *POS* module offers an interface and licenses to the *fiskaly&trade; cloud TSS* to fulfill the technical requirements for electronic recording and security systems in business transactions (Kassensicherungsverordnung (KassenSichV Germany)). 
