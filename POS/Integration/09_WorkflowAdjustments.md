...
Use your customer-specific order workflow to transfer all sales-related POS postings to the *Order Management* and the *Accounting* module. 
...
> [Info] The *Import channels order in OMS and create delivery note* workflow is available as example workflow in the standard. But because transitions of the *POS* module are not available in the standard, the processing described here is not part of this standard workflow.
