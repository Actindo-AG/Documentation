...
- [Create a store in POS](06_CreateStore.md)
  ...
  - [Create a store manually](06_CreateStore.md#create-a-store-manually)
    ...
    - [Configure the stock withdrawal matrix](06_CreateStore.md#configure-the-stock-withdrawal-matrix)
    - [Assign the stock source](06_CreateStore.md#assign-the-stock-source)
      - [Create a stock attribute](06_CreateStore.md#create-a-stock-attribute)
      - [Configure the stock allocation](06_CreateStore.md#configure-the-stock-allocation)
      - [Map the attribute to the stock of the store](06_CreateStore.md#map-the-attribute-to-the-stock-of-the-store)
