...
*POS > Management > Tab GLOBAL SETTINGS > Menu entry Payment methods (manual terminal payment)*
...
4. Enter a name for the payment method in POS in the *Name* field.   
    ...
    > [Info] The name of the payment method in POS can differ from the name of the payment method in the *Order Management* module. It is only necessary that the ID of the payment method in *Order Management* matches with the *Key* in *POS*.
