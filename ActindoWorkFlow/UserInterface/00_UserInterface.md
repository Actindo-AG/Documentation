...
- [OVERVIEW (Processes)](./03a_Processes.md)
  - [Process ID](./03a_Processes.md#process-id)
    ...
    - [Create view](./03a_Processes.md#create-view)  
...
- [SETTINGS](./07a_Settings.md)
  ...
  - [Error-log lifetime](./07a_Settings.md#error-log-lifetime)
  - [Warning-log lifetime](./07a_Settings.md#warning-log-lifetime)
  - [Notice-log lifetime](./07a_Settings.md#notice-log-lifetime)
  - [Info-log lifetime](./07a_Settings.md#info-log-lifetime)
  - [Debug-log lifetime](./07a_Settings.md#debug-log-lifetime)



- [Workflow core actions](./07_CoreActions.md)
  - [Change process priority](./07_CoreActions.md#change-process-priority)
  - [Multiply input action](./07_CoreActions.md#multiply-input-action)
  - [Execute PHP code](./07_CoreActions.md#execute-php-code)
  - [Split by criterion](./07_CoreActions.md#split-by-criterion)
  - [Start subprocess](./07_CoreActions.md#start-subprocess)
  - [Switch case action](./07_CoreActions.md#switch-case-action)
  - [Update process name and search string](./07_CoreActions.md#update-process-name-and-search-string)
  - [Wait for criterion](./07_CoreActions.md#wait-for-criterion)
  - [Wait for parallel input](./07_CoreActions.md#wait-for-parallel-input)
  - [Waiting action](./07_CoreActions.md#waiting-action)
