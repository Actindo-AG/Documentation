...
- Clicking the [ASSIGN RECEIPT] button in the *BOOKINGS* tab to assign a receipt to an already existing booking in the bookings list; see [Retrieve a receipt](#retrieve-a-receipt).
