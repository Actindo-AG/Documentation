...
- A fiscal year has been selected, see [Select the fiscal year](../Operation/01_SelectFiscalYear.md).
- A fixed posting batch is created, see [Create a fixed posting batch](#create-a-fixed-posting-batch).
...
- A fiscal year has been selected, see [Select the fiscal year](../Operation/01_SelectFiscalYear.md).
- At least one fixed posting batch is created, see [Create a fixed posting batch](#create-a-fixed-posting-batch).
