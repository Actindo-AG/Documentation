...
[comment]: <> (This function interacts with the *Purchasing* and *Payment processing* modules, and allows to check supplier receipts before booking them in the system and to automatize payment conditions.)
...
Click the drop-down list to select the mode. The following options are available:
  ...
  - **Use base address**  
  Select this option to use the base (standard) address. The rest of fields in this section are greyed out.

  - **Use different address**  
  Select this option to use a different address that the base address. The rest of fields in this section become activated.
...
- *All address types*  
Click this drop-down list to select the address type to be displayed in the list.
