...
1. Click the *Select connection* drop-down list and select the connection for which you want to import offers. All supported drivers are displayed in the list.   
    ...
    > [Info] If the importable products have already been downloaded, all offers in the selected marketplace are displayed in the list of importable products.
...
1. Click the *Select connection* drop-down list and select the connection for which you want to import offers. All supported drivers are displayed in the list.   
    All offers in the selected marketplace are displayed in the list of importable products.
