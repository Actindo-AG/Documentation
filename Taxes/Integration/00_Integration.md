...
- [Manage the tax classes](./02_ManageTaxClasses.md)
  ...
  - [Delete a tax class](./02_ManageTaxClasses.md#delete-a-tax-class)


- [Manage the tax zones](./03_ManageTaxZones.md)
  - [Create a tax zone](./03_ManageTaxZones.md#create-a-tax-zone)
  - [Edit a tax zone](./03_ManageTaxZones.md#edit-a-tax-zone)
  - [Delete a tax zone](./03_ManageTaxZones.md#delete-a-tax-zone)
