...
**List of intents**   
The list of intents contains all intents that are a summary of log entries generated by a system action. It provides you with the following UI functions:
