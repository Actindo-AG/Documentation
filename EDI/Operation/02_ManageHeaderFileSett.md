...
3. If you have not already done so, click the *Release* drop-down list and select the required release.

4. If you have not already done so, click the *Message type* drop-down list and enter the required message type.
...
7. Continue with [Specify message name &frasl; constant text value](#specify-document-name-⁄-constant-text-value). Alternatively, click the [SAVE] button in the upper right corner to save your settings.
...
1. Expand the S_BGM segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button.   
...
2. Expand the *S_BGM C_C002 (Identification of a type of document/message by code)* segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button. In most cases it is mandatory to specify this segment.   
...
2. Expand the *S_BGM C_C106* (Identification of a document/message by its number) segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button. In most cases it is required to specify this segment.   
...
6. If desired, check if the string attribute has been marked for a later data mapping. To do this, open the message definition again and click the *Data sources* tab.  
...
9. Continue with [Specify message dates](#specify-message-dates).
...
Each invoice can have many different dates, such as the invoice date, the expected delivery date, the tax point date, and more. The Actindo EDIFACT message structure contains only one DTM segment in its raw state. However, for many business partners, multiple DTM segments must be completed. As soon as you have specified one value in a DTM segment, a further *DTM* segment is added automatically so that you can specify as much *DTM* segments as your business partner require.
...
1. Expand the *S_DTM* (DATE &frasl; TIME &frasl; PERIOD) segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button.   
    The *S_DTM* segment in turn consists of the subordinate *C_C507* segment.

2. Expand the *C_C507* (Date and &frasl; or time, or period relevant to the) segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button. In most cases it is required to specify this segment.   
...
9. If desired, check if the string attribute has been marked for a later data mapping. For detailed information, see [Map data source](./05_ManageDataSources.md#map-data-source).   
...
1. Expand the *S_FTX* (FREE TEXT) segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button.   
    The *S_FTX* segment has been expanded. The individual fields and the subordinate *C_C107* and *C_C108* segments are displayed.
...
4. Expand the *C_C108 (Free text; one to five lines)* segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button.
    The *C_C108* segment has been expanded. The individual fields of this segment are displayed.
...
- You have expanded the message structure, see [Get header file segments](#get-header-file-segments).
- You have specified an S_FTX, see [Specify message free texts](#specify-message-free-texts).
...
3. If desired, check if the condition has been marked for a later data mapping. To do this, open the message again.
...
- You have expanded the message structure of the header file, see [Get header file segments](#get-header-file-segments).
...
5. If desired, check if the group has been marked for a later data mapping. For detailed information, see [Prepare data mapping for the line items](./04_ManageLineItemsFileStt.md#prepare-data-mapping-for-the-line-items).   
...
1. If you want to remove the data from a whole segment, click the ![Delete attribute](../../Assets/Icons/Trash10.png "[Delete attribute]")(Delete attribute) button to the right of the corresponding segment.   
    ...
    The segment is no longer highlighted with a small black border, the data is removed from the segment.
...
1. If you want to remove data from a segment row, expand the corresponding segment by clicking the ![Collapsed](../../Assets/Icons/NodeCollapsed.png "[Collapsed]") (Collapsed) button.   
