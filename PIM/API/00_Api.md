...
- [Products](./05_Products.md)
    ...
    - [Create a product](./05_Products.md#create-a-product)
        ...
        - [Sample: Single product in two languages](./05_Products.md#sample-single-product-in-two-languages)
        - [Sample: Single product with different prices pro scope](./05_Products.md#sample-single-product-with-different-prices-pro-scope)
        - [Sample: Master product](./05_Products.md#sample-master-product)
    ...
    - [Delete a product](./05_Products.md#delete-a-product)
        - [Sample: Delete a product](./05_Products.md#sample-delete-a-product)
    - [Move a product to recycle bin](./05_Products.md#move-a-product-to-recycle-bin)
        - [Sample: Move a product to recycle bin](./05_Products.md#sample-move-product-to-recycle-bin)
    - [Move a product to archive](./05_Products.md#move-a-product-to-archive)
        - [Sample: Move a product to archive](./05_Products.md#sample-move-product-to-archive)
    - [List products](./05_Products.md#list-products)
        - [Sample: List products by creation date](./05_Products.md#sample-list-products-by-creation-date)
