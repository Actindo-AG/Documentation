...
- [Manage the stock](./02_ManageStock.md)
    - [Create a manual stock posting](./02_ManageStock.md#create-a-manual-stock-posting)
        - [Manual stock posting of a single material](./02_ManageStock.md#manual-stock-posting-of-a-single-material)
        - [Manual stock posting of multiple materials](./02_ManageStock.md#manual-stock-posting-of-multiple-materials)
