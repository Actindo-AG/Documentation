...
- [Manage the queries](./01_ManageQueries.md)
    ...
    - [Edit a query](./01_ManageQueries.md#edit-a-query)
    - [Delete a query](./01_ManageQueries.md#delete-a-query)
...
- [Manage the query categories](./02_ManageQueryCategories.md)
    ...
    - [Edit a query category](./02_ManageQueryCategories.md#edit-a-query-category)
        ...
        - [Edit the query category data](./02_ManageQueryCategories.md#edit-the-query-category-data)
