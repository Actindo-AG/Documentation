...
2. Click the [DELETE] button in the editing toolbar.  
    The *Deleted InfluxDB time series xxxx* pop-up window is displayed. The *xxxx* indicates the identifier of the deleted InfluxDB time series as displayed in the *ID* column. The deleted InfluxDB time series is removed from the list of InfluxDB time series.
